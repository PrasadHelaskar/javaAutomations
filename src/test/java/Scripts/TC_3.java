...
{
	@Test
	public void  OrganizationWithIndustry() throws InterruptedException
	{
		...
		el.getUsername().sendKeys("");
		el.getPassword().sendKeys("");
		el.getSubmitbutton().click();
		el.getOrganization().click();
		driver.findElement(By.cssSelector("img[alt='Create Organization...']")).click();
		driver.findElement(By.name("accountname")).sendKeys("TestYentra3");
		WebElement dd = driver.findElement(By.name("industry"));
		Select se=new Select(dd);
		se.selectByValue("Engineering");
