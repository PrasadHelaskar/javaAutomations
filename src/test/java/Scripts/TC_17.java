...
{
	@Test
	public void CopyBillingAddress() throws InterruptedException
	{
		...
		4 naviagate to "create new organization"page by click on "+" image
		5 Check While Creating New Organization "Copy Billing Address" Select Option Is Enabled Or Not
		6 Logout*/
		...
		WebElement copy = driver.findElement(By.xpath("(//input[@name='cpy'])[2]"));
		copy.click();
		if(copy.isEnabled())
		{
		...
		{
			System.out.println("Copy Billing Address button is dosabled");
		}
		Thread.sleep(1000);
