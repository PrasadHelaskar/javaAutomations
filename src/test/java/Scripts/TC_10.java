...
{
	@Test
	public void userAministratot() throws InterruptedException
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4
		naviagate to "create new 
		organization"page by click on "+" image
		5
		create Organization With "Assigned To" 
		"User" as "Aministratot"
		6 Logout*/
		...
		driver.findElement(By.name("accountname")).sendKeys("TestYentra10");
		driver.findElement(By.cssSelector("input[value='U']")).click();
		WebElement option = driver.findElement(By.name("assigned_user_id"));
