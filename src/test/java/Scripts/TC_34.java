...
{
	@Test
	public void OrganizationSettings()
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 Check The "Organization Settings"
		5 Logout*/
		...
		driver.findElement(By.cssSelector("img[title='Organizations Settings']")).click();
		Assert.assertEquals(driver.getCurrentUrl(),"http://localhost:8888/index.php?module=Settings&action=ModuleManager&module_settings=true&formodule=Accounts&parenttab=Settings");
