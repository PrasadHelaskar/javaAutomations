...
{
	@Test
	public void MailerExport() throws InterruptedException
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 Check The "Mailer Export" From Organization Records
		5 Logout*/
		...
		driver.findElement(By.cssSelector("input[value='Mailer Export']")).click();
		Assert.assertEquals(driver.getCurrentUrl(),"http://localhost:8888/index.php?module=Accounts&action=index");
