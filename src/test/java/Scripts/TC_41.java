...
{
	@Test
	public void OrganizationNo()
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 Search The Organization by "Organization Number"
		...
		driver.findElement(By.name("search_text")).sendKeys("ACC74");
		WebElement med = driver.findElement(By.id("bas_searchfield"));
		Select se = new Select(med);
		se.selectByValue("account_no");
