...
{
	@Test
	public void EmailOptOut() throws InterruptedException
	{
		...
		5 create Organization With "Email Opt Out"
		6 Logout*/
		...
		driver.findElement(By.name("accountname")).sendKeys("TestYentra8");
		...
		{
			System.out.println("Check-box is unticked ");
		}
