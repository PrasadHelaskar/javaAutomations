...
{
	@Test
	public void ClearMemeberBox() throws InterruptedException
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 naviagate to "create new organization"page by click on "+" image
		5 create Organization With "Members Of"
		6 clear the member of text box
		7 Logout*/
		...
		driver.findElement(By.cssSelector("input[alt='Clear']")).click();
		Thread.sleep(1000);
