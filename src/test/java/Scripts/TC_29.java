...
{
	@Test
	public void OrganizationWebsite()
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 Search The Organization by "Organization Website"
		...
		driver.findElement(By.name("search_text")).sendKeys("www.prasad.com");
		WebElement med = driver.findElement(By.id("bas_searchfield"));
		Select se = new Select(med);
		se.selectByValue("website");
