...
{
	@Test
	public void OrganizationWithNotifyOwner() throws InterruptedException
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 naviagate to "create new organization"page by click on "+" image
		5 create Organization With "Notify Owner"
		6 Logout*/
		...
		driver.findElement(By.name("accountname")).sendKeys("TestYentra14");
