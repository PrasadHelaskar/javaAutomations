...
{
	@Test
	public void OrganizationWithOutShippingAddress() throws InterruptedException
	{
		/*1 navigate to application
		2 login to application
		3 navigate to organization
		4 naviagate to "create new organization"page by click on "+" image
		5 create Organization Without "Billing Address"
		6 Logout*/
		...
		driver.findElement(By.name("bill_street")).sendKeys("Deccan near Deccan GYMKHANA bus stand");
		driver.findElement(By.name("bill_pobox")).sendKeys("Deccan Pune");
		driver.findElement(By.name("bill_city")).sendKeys("Pune");
		driver.findElement(By.name("bill_state")).sendKeys("Maharashtra");
		driver.findElement(By.name("bill_code")).sendKeys("411052");
		driver.findElement(By.name("bill_country")).sendKeys("India");
		driver.navigate().refresh();
		driver.findElement(By.name("accountname")).sendKeys("TestYentra21");
